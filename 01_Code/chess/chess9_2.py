...
def synthetic_pub(seed_hex):
    ...
    # propagate the hash through SHA256 → SHA256 → RIPEMD160
    for _ in range(3):
...
prop = []
for h in MC:
    prop.append(synthetic_pub(h))

# ---------------------------------------------------------
# 2. Compute ΔH propagation differences
# ---------------------------------------------------------
...
# ---------------------------------------------------------
# 4. 3D Atlas embedding
# ---------------------------------------------------------
mds = MDS(n_components=3, dissimilarity="precomputed", random_state=42)
coords = mds.fit_transform(DH_mod81)
